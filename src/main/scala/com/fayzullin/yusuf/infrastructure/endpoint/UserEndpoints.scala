...
import com.fayzullin.yusuf.domain.{UserAlreadyExistsError, UserAuthenticationFailedError, UserNotFoundError}
import com.fayzullin.yusuf.domain.authentication.{Auth, LoginRequest, SignupRequest}
import com.fayzullin.yusuf.domain.users.{User, UserService}
